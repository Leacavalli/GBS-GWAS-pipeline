...
## 0. Install Java v.11 for Nextflow
```
module load python
...
```
mkdir NEXTFLOW_PIPELINE
cd NEXTFLOW_PIPELINE
  mkdir 0.RAW_READS
  mkdir 1.TRIMMED_READS
  mkdir 2.KRAKEN_REPORTS
  mkdir 3.FILTERED_READS
  mkdir 4.FASTQC
  mkdir 5.SEROTYPE_MLST
  mkdir 6.SNIPPY
  mkdir 7.ASSEMBLIES
  mkdir 8.ANNOTATION
  mkdir scripts
...
| 5 | Produce a phylogeney | [FastTree](http://www.microbesonline.org/fasttree/) |
...
mkdir 9.Post_Pipeline
cd 9.Post_Pipeline
mkdir 9.1.MultiQC
mkdir 9.2.Snippy_core
mkdir 9.3.Pangenome_analysis
mkdir 9.4.Unitig_counter
mkdir 9.5.FastTree
mkdir 9.6.GWAS
