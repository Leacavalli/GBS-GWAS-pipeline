...
process RAxML_MLsearch {
  ...
  raxml-ng --msa ${params.path_nextflow_dir}/11.SNIPPY_MULTI/clean.full.aln --model GTR+G --threads 50 --seed 12345 --prefix ${params.path_nextflow_dir}/12.Phylogeny/12.1.RAxML/T1
  """
}
...
process PanGWAS_Roary_Fasttree {
  ...
  # Run Pyseer
  pyseer --min-af 0.05 --max-af 0.95 --lmm --phenotypes ${params.path_nextflow_dir}/Files/phenotypes_filtered.txt --pres ${params.path_nextflow_dir}/13.Pangenome_analysis/13.2.ROARY/gene_presence_absence.Rtab --similarity ${params.path_nextflow_dir}/15.Pyseer/15.2.Subanalysis_1/15.2.1.Fasttree/FastTree_phylogeny_K.tsv --cpu 8 > ${params.path_nextflow_dir}/15.Pyseer/15.3.Subanalysis_2/PanGWAS_Panaroo_Fasttree_LMM.txt
