...
process FASTTREE {
  ...
  ${params.path_nextflow_dir}/Files/FastTree -gtr -gamma -nt ${params.path_nextflow_dir}/11.SNIPPY_MULTI/clean.full.aln > ${params.path_nextflow_dir}/12.Phylogeny/12.2.FastTree/GBS_GWAS_FastTree_phylo.tre
  """
}
